...
class AddProductSeoScreenState extends State<AddProductSeoScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          child: Consumer<AddProductController>(
            builder: (context, resProvider, child) {
              return SingleChildScrollView(
                child: (resProvider.attributeList != null && resProvider.attributeList!.isNotEmpty && resProvider.categoryList != null && Provider.of<SplashController>(context, listen: false).colorList != null)
                    ? Column(
                        ...
                        children: [
                          ...
                          Text(getTranslated('tags', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            Padding(
                              ...
                              child: Text(getTranslated('product_seo_settings', context)!, style: robotoBold.copyWith(color: ColorResources.getHeadTextColor(context), fontSize: Dimensions.fontSizeExtraLarge)),
                            ),
                          ]),
                          const SizedBox(height: Dimensions.paddingSizeSmall),

                          Text(getTranslated('meta_title', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          Text(getTranslated('meta_description', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          ...
                          Text(getTranslated('youtube_video_link', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          CustomTextFieldWidget(
                                  ...
                                  child: resProvider.pickedMeta != null
                                      ...
                                      : widget.product != null
                                          ? FadeInImage.assetNetwork(
                                              ...
                                              image: '${Provider.of<SplashController>(context).configModel!.baseUrls!.productImageUrl}/meta/${_product!.metaImage ?? ''}',
                                              height: 120,
                                              width: 150,
                                              fit: BoxFit.cover,
                                              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholderImage, height: 120, width: 150, fit: BoxFit.cover),
                                            )
                          ...
                          Text(getTranslated('thumbnail', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                ...
                                ClipRRect(
                                  ...
                                  child: resProvider.pickedLogo != null
                                      ...
                                      : widget.product != null
                                          ? FadeInImage.assetNetwork(
                                              placeholder: Images.placeholderImage,
                                              image: '${Provider.of<SplashController>(context).configModel!.baseUrls!.productThumbnailUrl}/${_product!.thumbnail ?? ''}',
                                              height: 120,
                                              width: 150,
                                              fit: BoxFit.cover,
                                              imageErrorBuilder: (c, o, s) => Image.asset(Images.placeholderImage, height: 120, width: 150, fit: BoxFit.cover),
                          ...
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                          Text(getTranslated('product_image', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                                              ...
                                              children: [
                                                DottedBorder(
                                                    ...
                                                    child: ClipRRect(
                                                        ...
                                                        child: (_update)
                                                            ? CustomImageWidget(
                                                                image: "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.withColor[index].imageString}",
                                                ...
                                                Positioned(bottom: 0, right: 0, top: 0, left: 0, child: Align(alignment: Alignment.center, child: Icon(Icons.camera_alt, color: Colors.black.withOpacity(.5), size: 40))),
                                                Positioned(
                                                    right: 5,
                                                    top: 5,
                                                    child: Container(
                                                        width: 30,
                                                        height: 30,
                                                        decoration: BoxDecoration(color: Color(int.parse(colorString)), borderRadius: BorderRadius.circular(20)),
                                                        child: Padding(padding: const EdgeInsets.all(8.0), child: Image.asset(Images.edit))))
                                              ],
                                            ),
                                          )
                                        : Stack(
                          ...
                          if (_update)
                            Consumer<AddProductController>(builder: (context, productProvider, _) {
                              return GridView.builder(
                                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(childAspectRatio: 1, crossAxisCount: 2, crossAxisSpacing: 10, mainAxisSpacing: 10),
                                  shrinkWrap: true,
                                  physics: const NeverScrollableScrollPhysics(),
                                            ...
                                            child: Container(
                                                ...
                                                child: ClipRRect(
                                                    ...
                                                    child: CustomImageWidget(
                                                        image: "${Provider.of<SplashController>(context, listen: false).configModel?.baseUrls?.productImageUrl}/${resProvider.imagesWithoutColor[index]}",
                                                        width: MediaQuery.of(context).size.width / 2.3,
                                                        height: MediaQuery.of(context).size.width / 2.3,
                                                        fit: BoxFit.cover)))),
                                        Positioned(
                                        ...
                                        child: Stack(
                                          children: [
                                            DottedBorder(
                                              ...
                                              child: ClipRRect(
                                                borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                                child: Image.asset(Images.placeholderImage, height: MediaQuery.of(context).size.width / 2.3, width: MediaQuery.of(context).size.width / 2.3, fit: BoxFit.cover),
                                              ),
                                            ),
                                            Positioned(
                                              bottom: 0,
                                          ...
                                          DottedBorder(
                                            ...
                                            child: Container(
                                              ...
                                              child: ClipRRect(
                                                borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingSizeSmall)),
                                                child: Image.file(
                                                  File(resProvider.withoutColor[index].image!.path),
                                                  width: MediaQuery.of(context).size.width / 2.3,
                                                  height: MediaQuery.of(context).size.width / 2.3,
                                                  fit: BoxFit.cover,
                                                ),
      ...
      bottomNavigationBar: Consumer<AddProductController>(builder: (context, resProvider, _) {
        return Container(
          height: 80,
              ...
              ? CustomButtonWidget(
                  ...
                  onTap: () {
                    ...
                    for (TextEditingController textEditingController in resProvider.titleControllerList) {
                      titleList = textEditingController.text.trim();
                    }
                    for (var description in resProvider.descriptionControllerList) {
                      descriptionList = description.text.trim();
                    }
                    ...
                    if (!_update && resProvider.pickedLogo == null) {
                      ...
                      _product!.discount = resProvider.discountTypeIndex == 0 ? double.parse(widget.discount!) : PriceConverter.systemCurrencyToDefaultCurrency(double.parse(widget.discount!), context);
                      ...
                      if (Provider.of<SplashController>(context, listen: false).configModel!.languageList != null && Provider.of<SplashController>(context, listen: false).configModel!.languageList!.isNotEmpty) {
                        for (int i = 0; i < Provider.of<SplashController>(context, listen: false).configModel!.languageList!.length; i++) {

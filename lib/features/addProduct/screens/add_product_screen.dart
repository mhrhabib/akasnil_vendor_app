...
class AddProductScreenState extends State<AddProductScreen> with TickerProviderStateMixin {
  ...
  Future<void> _load() async {
    String languageCode = Provider.of<LocalizationController>(context, listen: false).locale.countryCode == 'US' ? 'en' : Provider.of<LocalizationController>(context, listen: false).locale.countryCode!.toLowerCase();
  ...
  void initState() {
    super.initState();
    _tabController = TabController(length: Provider.of<SplashController>(context, listen: false).configModel!.languageList!.length, initialIndex: 0, vsync: this);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Consumer<AddProductController>(
        builder: (context, resProvider, child) {
          ...
          return widget.product != null && resProvider.editProduct == null
              ...
              : length != null
                  ? Consumer<SplashController>(builder: (context, splashController, _) {
                      return SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 280, child: TabBarView(controller: _tabController, children: _generateTabPage(resProvider))),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                            Provider.of<SplashController>(context, listen: false).configModel!.digitalProductSetting == "1" ? DigitalProductWidget(resProvider: resProvider, product: widget.product) : const SizedBox(),
                            Container(
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '*',
                                        style: robotoBold.copyWith(color: ColorResources.mainCardFourColor(context), fontSize: Dimensions.fontSizeDefault),
                                      ),
                                      const Spacer(),
                                      InkWell(
                                          onTap: () {
                                ...
                                ? Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(getTranslated('select_brand', context)!, style: robotoRegular.copyWith(color: ColorResources.titleColor(context), fontSize: Dimensions.fontSizeDefault)),
                                ...
                                ? Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Text(getTranslated('select_unit', context)!, style: robotoRegular.copyWith(color: ColorResources.titleColor(context), fontSize: Dimensions.fontSizeDefault)),
                                            Text(
                                              '*',
                                              style: robotoBold.copyWith(color: ColorResources.mainCardFourColor(context), fontSize: Dimensions.fontSizeDefault),
                                            ),
      ...
      bottomNavigationBar: Container(
        ...
        child: Consumer<AddProductController>(builder: (context, resProvider, _) {
              ...
              ? SizedBox(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      } else if ((resProvider.productTypeIndex == 1 && resProvider.digitalProductTypeIndex == 1 && resProvider.selectedFileForImport == null) && widget.product == null) {
                      ...
                      //}
                        ...
                        if (resProvider.productTypeIndex == 1 && resProvider.digitalProductTypeIndex == 1 && resProvider.selectedFileForImport != null) {
  ...
  List<Widget> _generateTabChildren() {
    ...
    for (int index = 0; index < Provider.of<SplashController>(context, listen: false).configModel!.languageList!.length; index++) {
      tabs.add(Text(Provider.of<SplashController>(context, listen: false).configModel!.languageList![index].name!.capitalize(), style: robotoBold.copyWith()));
    }
    return tabs;
  }

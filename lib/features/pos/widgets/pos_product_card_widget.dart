          ...
          return GestureDetector(
            onTap: () {
              if (widget.productModel.variation!.isNotEmpty) {
                showModalBottomSheet(context: context, isScrollControlled: true, backgroundColor: Theme.of(context).primaryColor.withOpacity(0), builder: (con) => CartBottomSheetWidget(product: widget.productModel));
              }
            },
            child: Stack(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      boxShadow: [BoxShadow(color: Theme.of(context).primaryColor.withOpacity(.05), spreadRadius: 1, blurRadius: 1, offset: const Offset(1, 2))]),
                  child: Row(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          children: [
                            ...
                            Text(
                              getTranslated(widget.productModel.productType, context)!,
                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(widget.productModel.name ?? '', style: robotoRegular.copyWith(), maxLines: 2, overflow: TextOverflow.ellipsis),
                ...
                widget.productModel.variation!.isNotEmpty
                    ? Positioned(
                        right: Provider.of<LocalizationController>(context, listen: false).isLtr ? 10 : null,
                        bottom: 10,
                        left: Provider.of<LocalizationController>(context, listen: false).isLtr ? null : 10,
                        child: Align(alignment: Alignment.bottomRight, child: Icon(Icons.add_circle, color: Theme.of(context).primaryColor, size: Dimensions.incrementButton)))
                    : Positioned(
                        right: Provider.of<LocalizationController>(context, listen: false).isLtr ? 10 : null,
                        bottom: 10,
                        left: Provider.of<LocalizationController>(context, listen: false).isLtr ? null : 10,
                              ...
                              children: [
                                product.cartQuantity[widget.index!]! > 0
                                    ? InkWell(
                                        ...
                                        child: Icon(Icons.remove_circle, color: product.cartQuantity[widget.index!]! > 1 ? Theme.of(context).colorScheme.onPrimary : Theme.of(context).hintColor, size: Dimensions.incrementButton),
                                      )
                                    : const SizedBox(),
                                product.cartQuantity[widget.index!]! > 0
                                    ? Center(

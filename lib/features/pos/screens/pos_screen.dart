    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverToBoxAdapter(child: Consumer<CartController>(builder: (context, cartController, _) {
              productDiscount = 0;
              total = 0;
              productTax = 0;
              subTotal = 0;
              if (cartController.customerCartList.isNotEmpty) {
                ...
                for (int i = 0; i < cartController.customerCartList[cartController.customerIndex].cart!.length; i++) {
                  ...
                  productDiscount = cartController.customerCartList[cartController.customerIndex].cart![i].product!.discountType == 'flat'
                      ...
                      : productDiscount +
                          (cartController.customerCartList[cartController.customerIndex].cart![i].product!.discount! / 100) *
                              cartController.customerCartList[cartController.customerIndex].cart![i].product!.unitPrice! *
                              cartController.customerCartList[cartController.customerIndex].cart![i].quantity!;
                  if (cartController.customerCartList[cartController.customerIndex].cart![i].product!.taxModel == "exclude") {
                    productTax = productTax +
                        (cartController.customerCartList[cartController.customerIndex].cart![i].product!.tax! / 100) *
                            cartController.customerCartList[cartController.customerIndex].cart![i].product!.unitPrice! *
                            cartController.customerCartList[cartController.customerIndex].cart![i].quantity!;
                  }
                }
              ...
              return Column(
                children: [
                  ...
                  Consumer<CartController>(builder: (context, customerController, _) {
                    return Container(
                            ...
                            children: [
                              GestureDetector(
                                  ...
                                  child: Container(
                                      ...
                                      child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSize), child: Text(customerController.searchCustomerController.text)))),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              CustomButtonWidget(
                  ...
                  Consumer<CartController>(builder: (context, customerCartController, _) {
                    return customerCartController.customerCartList.isNotEmpty
                        ? Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(color: Theme.of(context).cardColor, border: Border.all(width: .5, color: Theme.of(context).hintColor.withOpacity(.7)), borderRadius: BorderRadius.circular(Dimensions.paddingSizeMediumBorder)),
                              child: DropdownButton<int>(
                                ...
                                items: customerCartController.customerIds.map((int? value) {
                                  ...
                                  return DropdownMenuItem<int>(
                                      value: value, child: Text(customerCartController.customerCartList[(customerCartController.customerIds.indexOf(value))].customerName ?? '', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall)));
                                }).toList(),
                                onChanged: (int? value) async {
                                  ...
                                  customerCartController.setCustomerInfo(
                                      customerCartController.customerCartList[customerCartController.customerIndex].userId, customerCartController.customerCartList[(customerCartController.customerIndex)].customerName, '', true);
                      ...
                      ? Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(color: Theme.of(context).cardColor, boxShadow: [
                              BoxShadow(
                                  color: Provider.of<ThemeController>(context, listen: false).darkTheme ? Theme.of(context).primaryColor.withOpacity(0) : Theme.of(context).primaryColor.withOpacity(.05),
                                  blurRadius: 1,
                                  spreadRadius: 1,
                            ...
                            child: Column(
                              ...
                              children: [
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          ...
                                          child: CustomButtonWidget(
                                            btnTxt: getTranslated('edit_discount', context),
                                            onTap: () {
                                              showAnimatedDialogWidget(context, const ExtraDiscountAndCouponDialogWidget(), dismissible: false, isFlip: false);
                                            },
                                          )),
                                    ],
                                  ),
                                ...
                                PricingWidget(
                                  ...
                                  amount: PriceConverter.convertPrice(context, couponAmount),
                                  isCoupon: true,
                                  onTap: () {
                                    showAnimatedDialogWidget(context, const CouponDialogWidget(), dismissible: false, isFlip: false);
                                  },
                                ),
                                PricingWidget(title: getTranslated('extra_discount', context), amount: PriceConverter.discountCalculation(context, subTotal, cartController.extraDiscountAmount, cartController.selectedDiscountType)),
                                          ...
                                          return Padding(
                                            ...
                                            child: GestureDetector(
                                              ...
                                              child: Container(
                                                ...
                                                child: Center(
                                                    child: Text(
                                                  getTranslated(_paymentVia[index], context)!,
                                                  style: robotoRegular.copyWith(
                                                      color: cartController.paymentTypeIndex == index ? Colors.white : null, fontSize: cartController.paymentTypeIndex == index ? Dimensions.fontSizeLarge : Dimensions.fontSizeDefault),
                                                )),
                                              ),
                                            ),
                                          );
                                                              ...
                                                              : () {
                                                                  ...
                                                                  for (int index = 0; index < cartController.customerCartList[cartController.customerIndex].cart!.length; index++) {
                                                                    ...
                                                                    carts.add(Cart(
                                                                      ...
                                                                      cart.price.toString(),
                                                                      cart.product!.discountType == 'flat' ? productDiscount + cart.product!.discount! : productDiscount + ((cart.product!.discount! / 100) * cart.product!.unitPrice!),
                                                                      cart.quantity,
                                                                      cart.variant,

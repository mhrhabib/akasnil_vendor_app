          ...
          slivers: [
            SliverPersistentHeader(
                ...
                delegate: SliverDelegateWidget(
                    height: 85,
                    child: Consumer<ProductController>(builder: (context, searchProductController, _) {
                      return Container(
                        ...
                        child: Padding(
                          ...
                          child: CustomSearchFieldWidget(
                            ...
                            filterAction: () async {
                              ...
                              showModalBottomSheet(backgroundColor: Colors.transparent, isScrollControlled: true, context: context, builder: (_) => const CategoryFilterBottomSheetWidget());
                            },
                          ),
                        ),
                      );
              ...
              child: Consumer<ProductController>(builder: (context, prodProvider, child) {
                ...
                return Stack(
                  children: [
                    Column(children: [
                      ...
                      productList != null
                          ? productList.isNotEmpty
                              ? PosProductListWidget(productList: productList, scrollController: _scrollController, productProvider: prodProvider)
                              : Padding(
                    ...
                    prodProvider.showDialog ? const ProductSearchDialogWidget() : const SizedBox(),
                  ],
                );
              }),
            )

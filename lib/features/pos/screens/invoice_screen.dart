        ...
        return SingleChildScrollView(
          child: Consumer<CartController>(builder: (context, cartController, _) {
            ...
            if (cartController.invoice != null && cartController.invoice!.orderAmount != null) {
              ...
              totalPayableAmount = orderAmount + cartController.totalTaxAmount - cartController.discountOnProduct - extraDiscountAmount - cartController.invoice!.discountAmount! + includeTax!;
            }
            return Column(
              children: [
                Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text('${getTranslated('invoice', context)!.toUpperCase()} # ${widget.orderId}', style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                  Text(getTranslated('payment_method', context)!, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                ],
                              ),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text(DateConverter.dateTimeStringToMonthAndTime(cartController.invoice!.createdAt!), style: robotoRegular),
                              ...
                              InvoiceElementViewWidget(serial: getTranslated('sl', context), title: getTranslated('product_info', context), quantity: getTranslated('qty', context), price: getTranslated('price', context), isBold: true),
                              const SizedBox(height: Dimensions.paddingSizeDefault),
                              ListView.builder(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(PriceConverter.convertPrice(context, totalPayableAmount), style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                ],
                              ),
                              const SizedBox(height: Dimensions.paddingSizeDefault),

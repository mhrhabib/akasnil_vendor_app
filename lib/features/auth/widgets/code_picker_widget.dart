...
class CodePickerWidgetState extends State<CodePickerWidget> {
            ...
            children: <Widget>[
              ...
              if (widget.showDropDownButton)
                Flexible(
                  ...
                  fit: widget.alignLeft ? FlexFit.tight : FlexFit.loose,
                  child: Padding(
                      padding: widget.alignLeft ? const EdgeInsets.only(right: 0.0, left: 8.0) : const EdgeInsets.only(right: 0.0),
                      child: Icon(
  ...
  void initState() {
    ...
    if (widget.initialSelection != null) {
      selectedItem = elements.firstWhere((item) => (item.code!.toUpperCase() == widget.initialSelection!.toUpperCase()) || (item.dialCode == widget.initialSelection) || (item.name!.toUpperCase() == widget.initialSelection!.toUpperCase()),
          orElse: () => elements[0]);
    } else {
      selectedItem = elements[0];
    }

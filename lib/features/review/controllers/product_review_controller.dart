...
class ProductReviewController extends ChangeNotifier {
  ...
  Future<void> filterReviewList(
    ...
    ApiResponse apiResponse =
        await reviewServiceInterface.filterProductReviewList(productId, customerId, _reviewStatusIndex, _startDate != null ? dateFormat.format(_startDate!).toString() : null, _endDate != null ? dateFormat.format(_endDate!).toString() : null);
    if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {

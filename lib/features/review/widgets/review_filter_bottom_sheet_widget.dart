...
class _ReviewFilterBottomSheetWidgetState extends State<ReviewFilterBottomSheetWidget> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Consumer<ProductReviewController>(builder: (context, reviewProvider, _) {
        return Consumer<ProductController>(builder: (context, productProvider, _) {
          return Container(
            decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: const BorderRadius.only(topLeft: Radius.circular(Dimensions.paddingSizeDefault), topRight: Radius.circular(Dimensions.paddingSizeDefault))),
            child: Column(
              ...
              children: [
                  ...
                  Consumer<ProductReviewController>(
                    builder: (context, productReviewController, _) {
                      return CustomContainerWidget(
                          ...
                          onTap: () {
                            showDialog(context: context, barrierDismissible: true, builder: (_) => const ReviewProductFilterWidget());
                          });
                    },
                  ),
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Row(
                                  children: [
                                    Expanded(child: Text(cartController.searchCustomerController.text.trim().isNotEmpty ? cartController.searchCustomerController.text : '${getTranslated('select_customer', context)}')),
                ...
                CustomDropDownItemWidget(
                  widget: DropdownButtonFormField<String>(
                    ...
                    style: robotoRegular,
                    onChanged: (value) {
                      reviewProvider.setReviewStatusIndex(value == 'select_status'
                          ? 0
                          : value == 'Active'
                              ? 1
                              : 2);
                    ...
                    items: reviewProvider.reviewStatusList.map<DropdownMenuItem<String>>((String value) {
                      return DropdownMenuItem<String>(
                        value: value,
                        child: Text(getTranslated(value, context)!, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
                      );
                    }).toList(),
                  ),
                ),
                Row(
                  children: [
                    Expanded(
                      ...
                      text: reviewProvider.startDate != null ? reviewProvider.dateFormat.format(reviewProvider.startDate!).toString() : getTranslated('select_date', context),
                    ...
                    Expanded(
                      ...
                      image: Images.calenderIcon,
                      text: reviewProvider.endDate != null ? reviewProvider.dateFormat.format(reviewProvider.endDate!).toString() : getTranslated('select_date', context),

                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: CustomImageWidget(
                            image: '${Provider.of<SplashController>(context, listen: false).baseUrls!.productThumbnailUrl}/${reviewModel!.product!.thumbnail}',
                          )),
                    ),
                  ),
                ...
                child: Column(
                  ...
                  children: [
                    reviewModel!.customer != null
                        ? Text('${reviewModel!.customer!.fName ?? ''}' '${reviewModel!.customer!.lName ?? ''}', style: titilliumSemiBold.copyWith(fontSize: Dimensions.fontSizeLarge), maxLines: 1, overflow: TextOverflow.ellipsis)
                        : const SizedBox(),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                    Text(reviewModel!.product!.name ?? '', style: robotoRegular.copyWith(color: ColorResources.titleColor(context)), maxLines: 1, overflow: TextOverflow.ellipsis),
                    Row(children: [
                      Icon(Icons.star, color: Provider.of<ThemeController>(context).darkTheme ? Colors.white : Colors.orange, size: Dimensions.iconSizeDefault),

                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          children: [
                            Align(
                                alignment: Provider.of<LocalizationController>(context, listen: false).isLtr ? Alignment.centerLeft : Alignment.bottomRight,
                                child: Text(getTranslated('product_reviews', context)!, style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault))),
                            Text((review.productReviewModel?.averageRating ?? review.productReviewModel?.averageRating.toString()) ?? '',
                                style: robotoBold.copyWith(color: Theme.of(context).colorScheme.primary, fontSize: Dimensions.fontSizeOverlarge)),
                            RatingBarIndicatorWidget(
                              ...
                              itemBuilder: (context, index) => Icon(Icons.star_rate_rounded, color: Theme.of(context).primaryColor.withOpacity(.75)),
                              itemCount: 5,

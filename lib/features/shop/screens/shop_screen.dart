          ...
          return shopInfo.shopModel != null
              ? Consumer<ProfileController>(builder: (context, profileProvider, _) {
                  return SingleChildScrollView(
                    child: Consumer<SplashController>(builder: (context, splashProvider, _) {
                      return Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ShopBannerWidget(resProvider: shopInfo),
                          Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall), child: ShopInformationWidget(resProvider: shopInfo)),
                          Padding(
                            padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                            child: Container(
                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall), boxShadow: ThemeShadow.getShadow(context), color: Theme.of(context).cardColor),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  ...
                                  if (splashProvider.configModel?.minimumOrderAmountStatus == 1)
                                    Padding(
                                        ...
                                        child: CustomTextFieldWidget(border: true, controller: minimumOrderAmountController, isAmount: true, hintText: '${getTranslated('enter_minimum_order_amount', context)}')),
                                    ...
                                    Consumer<ProfileController>(builder: (context, profileProvider, _) {
                                      return Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            Expanded(
                                                child: Text('${getTranslated('free_delivery_over_amount', context)} (${Provider.of<SplashController>(context, listen: false).myCurrency!.symbol})',
                                  ...
                                  if (splashProvider.configModel?.freeDeliveryStatus == 1 && splashProvider.configModel?.freeDeliveryResponsibility == 'seller')
                                    Padding(
                                      padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeDefault),
                                      child: CustomTextFieldWidget(border: true, controller: freeDeliveryOverAmountController, isAmount: true, hintText: '${getTranslated('enter_free_delivery_over_amount', context)}'),
                                    ),
                                                ...
                                                onTap: () {
                                                  if (freeDeliveryOverAmountController.text.trim().isEmpty && minimumOrderAmountController.text.trim().isEmpty) {
                                                    ...
                                                    shopInfo.updateShopInfo(
                                                        freeDeliveryOverAmount: freeDeliveryOverAmountController.text.trim(), freeDeliveryStatus: freeDeliveryOn ? "1" : "0", minimumOrderAmount: minimumOrderAmountController.text.trim());
                                                  }
                                                },
                                              )),
                                        ),
                          ...
                          Padding(
                            padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
                            child: Container(
                              decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall), boxShadow: ThemeShadow.getShadow(context)),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                          ...
                          if (splashProvider.configModel!.activeTheme == "theme_aster")
                            Padding(
                              padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge, top: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeDefault),
                              child: Row(
                                children: [
                                  Text('${getTranslated('store_secondary_banner', context)}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                ],
                              ),
                            ),
                          ...
                          if (splashProvider.configModel!.activeTheme == "theme_fashion")
                            Padding(
                                padding: const EdgeInsets.only(left: Dimensions.paddingSizeLarge, top: Dimensions.paddingSizeDefault, right: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeDefault),
                                child: Row(children: [Text('${getTranslated('offer_banner', context)}', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault))])),
...
class ShopSettingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer<ShopController>(builder: (context, shop, _) {
      return Container(
        padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
        decoration: BoxDecoration(color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall), border: Border.all(color: Theme.of(context).primaryColor.withOpacity(.125))),
        child: Row(
          children: [
            Expanded(
                child: Text(
            ...
            dateSelection
                ? InkWell(
                    onTap: onPress,
                    child: Container(
                      decoration: BoxDecoration(border: Border.all(color: Theme.of(context).primaryColor, width: .25), borderRadius: BorderRadius.circular(50)),
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall), child: Icon(Icons.arrow_forward_rounded, size: Dimensions.iconSizeDefault, color: Theme.of(context).primaryColor)),
                ...
                : FlutterSwitch(value: mode!, width: 50, height: 27, activeColor: Theme.of(context).primaryColor, toggleSize: 20, padding: 2, onToggle: onTap!)
          ],
        ),
      );
    });

              ...
              child: SizedBox(
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    Expanded(
                      child: Container(
                        decoration: BoxDecoration(border: Border.all(color: Theme.of(context).primaryColor, width: 1), borderRadius: BorderRadius.circular(Dimensions.radiusDefault)),
                        child: TextField(
                            ...
                            suffixIcon: Row(
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall), child: Image.asset(Images.file, height: 30, width: 30)),
                                ),
                                GestureDetector(
                                  onTap: () => chatController.pickMultipleImage(false),
                                  child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeExtraSmall), child: Image.asset(Images.attachment, height: 30, width: 30, color: Theme.of(context).primaryColor)),
                                ),
                              ],
                            ),
                          ),
                        ...
                        : GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: SizedBox(
                                ...
                                child: Image.asset(Images.send, color: chatController.isSendButtonActive ? Theme.of(context).primaryColor : ColorResources.hintTextColor),
                              ),
                            ),
                          ),
                  ]),

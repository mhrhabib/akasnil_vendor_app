...
class _QuantityUpdateDialogWidgetState extends State<QuantityUpdateDialogWidget> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
        ...
        child: Consumer<AddProductController>(builder: (context, resProvider, child) {
          List<int> colors = [];
          colors.add(0);

          if (Provider.of<AddProductController>(context, listen: false).attributeList != null && Provider.of<AddProductController>(context, listen: false).attributeList!.isNotEmpty) {
            if (addColor == 0) {
              addColor++;
                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          resProvider.attributeList != null ? AttributeViewWidget(product: widget.product, colorOn: resProvider.attributeList![0].active, onlyQuantity: true) : const CircularProgressIndicator(),
                          Container(
                              margin: const EdgeInsets.only(left: Dimensions.paddingSizeLarge, right: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeSmall),
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(getTranslated('total_quantity', context)!, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),

              ...
              Expanded(
                ...
                Row(
                  children: [
                    ...
                    Padding(padding: const EdgeInsets.only(left: Dimensions.paddingSizeExtraSmall), child: Text(reviewModel.rating.toString(), style: robotoRegular.copyWith(color: Theme.of(context).hintColor))),
                  ],
                ),
              ])),
              const SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                          onTap: () => showDialog(context: context, builder: (ctx) => ImageDialogWidget(imageUrl: '$review/review/${reviewModel.attachment![index]}')),
                          child: Padding(
                            ...
                            child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CustomImageWidget(
                                    image: '$review/review/${reviewModel.attachment![index]}',
                                    width: Dimensions.productImageSize,
                                    height: Dimensions.productImageSize,
                                  ),
                                )),
